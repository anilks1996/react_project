...
const ReceiptsPaymentsAccounts = () => {
  ...
  return (
    <div>
      <form>
        <span><Card style={{ height: '3rem', background: 'lightgrey', width: '70rem' }}>home/ financial statements / receipts - payment a/c
        </Card></span><br />
        <Card>
          <CardHeader>
          ...
          <Table >
            <th>
              <div class="container text-center">
                <div class="row">
                  <div class="col-4">
                  Show Vertical Receipts And Payments A/c	
                  </div>
                  <div class="col-1">
...
export default ReceiptsPaymentsAccounts