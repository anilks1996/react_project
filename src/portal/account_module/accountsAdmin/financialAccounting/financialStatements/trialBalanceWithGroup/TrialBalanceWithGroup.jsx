...
const TrialBalanceWithGroup = () => {
  ...
  return (
    <div>
      <form>
        <span><Card style={{ height: '3rem', background: 'lightgrey', width: '70rem' }}>home/ financial statements / trial balance with group
        </Card></span><br />
        <Card>
          <CardHeader>
  ...
  <table class="forumline" width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
  <td nowrap align="left"><span class="required" style={{color:'red'}}>*</span><label>Level :</label></td>
	<td nowrap>
  </td>
  <tr>
  <td nowrap>
	<input type='number' id='levelId'/>
  </td>
  </tr>
  </tr>
  </table>
...
export default TrialBalanceWithGroup