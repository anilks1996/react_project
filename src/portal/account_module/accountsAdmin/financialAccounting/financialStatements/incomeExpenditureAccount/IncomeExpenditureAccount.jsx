...
const IncomeExpenditureAccount = () => {
  ...
  return (
    <div>
      <form>
        <span><Card style={{ height: '3rem', background: 'lightgrey', width: '70rem' }}>home/ financial statements / income - expenditure a/c
        </Card></span><br />
        <Card>
          <CardHeader>
            <Button onClick={() => navigate("/AccountsProfile")} color="danger">Back</Button>{' '}
            <Button color="dark">Monthly Report</Button>{' '}
            <Button color="dark">Income Expenditure Mapping</Button>{' '}
          </CardHeader>
...
<div class="container text-center">
                <div class="row">
                  <div class="col-4">
                  Show Vertical Income-Expense A/c	
                  </div>
                  <div class="col-1">
