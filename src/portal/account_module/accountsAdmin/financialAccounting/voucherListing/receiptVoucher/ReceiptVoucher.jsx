...
const ReceiptVoucher = () => {
  ...
  useEffect(()=>{
    ...
    dispatch(populateVoucherNoColl(2));
  ...
  return (
    <div>
      <form style={{minWidth:"80rem", fontSize:'0.9rem'}}>
          <Card className="p-2">
            Home / voucher listing / receipt voucher
          </Card>
        <Card className="form-shadow">
          <CardHeader>
            <Row>
              <Col sm={5}><Button onClick={() => navigate("/AccountsProfile")} color="danger"> Back </Button></Col>
              <Col sm={6}><strong style={{color:'rgb(38,160,181)'}}>Receipt Voucher</strong> </Col>
            </Row>
          </CardHeader>
          <CardBody>
            <Row className="p-2">
              ...
              <Col>                  
                  <label>                                
                    <Autocomplete {...accChartProps} id="voucher.id" value={chartValue}
                      ...
                      />
                    <i style={{color:'blue'}}>Type voucher no like :- RV00001</i>
                  </label>
              </Col>
              <Col>
                <label>
                  <Button color="primary" onClick={fetchVoucherTransaction} className="p-2 button-color" style={{ width:'20rem'}}> Fetch </Button>
                </label>
              </Col>
            </Row>
          </CardBody>  
