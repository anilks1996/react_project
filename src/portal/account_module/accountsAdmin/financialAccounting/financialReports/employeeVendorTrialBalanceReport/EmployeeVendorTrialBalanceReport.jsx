...
const EmployeeVendorTrialBalanceReport = () => {
...
return (
  <div>
  <form>
 <span><Card style={{height:'3rem', background:'lightgrey', width:'70rem'}}>home/ financial reports / emp/vendor trial balance report
  </Card></span><br/>
  <Card>
  <CardHeader>
  ...
  <table class="forumline" width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
  <td nowrap align="left"><label>Show Amount In Lakhs : </label>
	</td>
	<td align="left">
...
export default EmployeeVendorTrialBalanceReport;