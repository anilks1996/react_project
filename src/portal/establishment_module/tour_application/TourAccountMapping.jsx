...
const TourAccountMapping = () => {
    const navigatePage=useNavigate();
    const goback=()=>{
        window.history.back();
    }
    const searchDesignation=()=>{
        navigatePage("/serviceBookDetails/tourAccountMapping");
    }
  return (
    <div>
      <form>
        <Card style={{minWidth:'70rem'}}>
            <CardHeader  className='p-0'>
                <label>Establishment / TourAccountMapping</label>
            </CardHeader>
            <CardHeader className='p-0'>
...
export default TourAccountMapping;
