...
import { Button, Card, CardBody, Modal, ModalBody, ModalFooter, ModalHeader, Spinner, Table } from 'reactstrap';
...
import { findArchivedWorkflowByEmployeeId, findDraftWorkflowByEmployeeId } from './inboxEmployeeSlice';
import { Divider } from '@mui/material';
import DateDisplay from './DateDisplay';


const ArchivedBoxEmployeeUser = () => {
    ...
    const {inboxEmployees,inboxItems,sentItems,draftItems,archivedItems} = useSelector((state)=>state.allstorereducer.inboxEmployee);
    ...
    React.useEffect(()=>{
        ...
        if(ustoken!=null){
            dispatch(findArchivedWorkflowByEmployeeId(ustoken));
        }    
                ...
                <div>
                    ...
                    <div>  
                        ...
                        <div>
                        {
                            ...
                            <div>  
                                <b> Purchase Order </b> : {" "}[{params.row.modelCode}] 
                                <Divider />
                                {params.row.itemDetails1}
                            </div>
                            :
                            <div>
                            {
                                ...
                                <div>  
                                    <b> Tender </b> : {" "}[{params.row.modelCode}] 
                                    <Divider />
                                    {params.row.itemDetails1}
                                </div>
                                :
                                <div>
                                {
                                    ...
                                    <div>  
                                        <b> Store Request </b> : {" "}[{params.row.modelCode}] 
                                        <Divider />
                                        {params.row.itemDetails1}
                                    </div>
                                    :
                                    <div>
                                    {
                                        ...
                                        <div>  
                                            <b> Stores Issue </b> : {" "}[{params.row.modelCode}] 
                                            <Divider />
                                            {params.row.itemDetails1}
                                        </div>
                                        :
                                        <div>
                                        {
                                            ...
                                            <div>  
                                                <b> Engineering Estimate </b> : {" "}[{params.row.modelCode}] 
                                                <Divider />
                                                {params.row.itemDetails1}
                                            </div>
                                            :
                                            <div>
                                            {
                                                ...
                                                <div>  
                                                    <b> Engineering Work </b> : {" "}[{params.row.modelCode}] 
                                                    <Divider />
                                                    {params.row.itemDetails1}
                                                </div>
                                                :
                                                <div>
                                                {
                                                    ...
                                                    <div>  
                                                        <b> Online Payment </b> : {" "}[{params.row.modelCode}] 
                                                        <Divider />
                                                        {params.row.itemDetails1}
                                                    </div>
                                                    :
                                                    <div>
                                                    {
                                                        ...
                                                        <div>  
                                                            <b> Tour Application  </b> : {" "}[{params.row.modelCode}] 
                                                            <Divider />
                                                            {params.row.itemDetails1}
                                                        </div>
                                                        :
                                                        <div>
                                                        {
                                                            ...
                                                            <div>  
                                                                <b> Tour Claim Expense </b> : {" "}[{params.row.modelCode}] 
                                                                <Divider />
                                                                {params.row.itemDetails1}
                                                            </div>
                                                            :
  ...
  return (
    ...
    <div>
      <Card className='form-shadow p-2' style={{minWidth:'72rem', marginLeft:'1rem'}}>
         {
            archivedItems.length>0? 
            <div>
              <ParentChildDataGrid data={archivedItems} onRowClick={handleRowClick} />
            </div>
            :
            <div>
              <p><Spinner></Spinner></p>  
...
export default ArchivedBoxEmployeeUser;
